...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-guy-a4-the-prime-number-race-a661d961-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GUY-A4"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-guy-a4-the-prime-number-race-a661d961-v1",
      "problem_contract_sha256": "a709dc0be7590c91dd1cd7b121a09c48262e4c0d27afa2a6c8e221e40e1dce93",
      "problem_id": "problem:um-guy-a4-the-prime-number-race-a661d961",
      "route_id": "route:um-guy-a4-the-prime-number-race-a661d961-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-guy-a4-the-prime-number-race-a661d961-source-fidelity-01",
      "graph_id": "graph:um-guy-a4-the-prime-number-race-a661d961-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-guy-a4-the-prime-number-race-a661d961-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-guy-a4-the-prime-number-race-a661d961-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $\\pi(n; a, b)$ be the number of primes $p \\le n$ with $p \\equiv a \\pmod b$. For every $a$ and $b$ with $a \\perp b$, are there infinitely many values of $n$ for which $\\pi(n; a, b) > \\pi(n; a_1, b)$ for every $a_1 \\not\\equiv a \\pmod b$?"
          },
          "statement_sha256": "e8e0483f22330e445b5b444727382a8b47eaf3289a936636a4ba875ed0f13bff"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-guy-a4-the-prime-number-race-a661d961-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-guy-a4-the-prime-number-race-a661d961-root",
      "route_id": "route:um-guy-a4-the-prime-number-race-a661d961-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-guy-a4-d4fa9dca78d2",
        "url": "https://www.unsolvedmath.com/problems/GUY-A4"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
